        ...
        holder.btnMore.setOnClickListener(v -> {
            ...
            btnEdit.setOnClickListener(view -> {
                ...
                if (currentPos != RecyclerView.NO_POSITION) {
                    ...
                    String type = todoToEdit.getTodoField().toUpperCase(Locale.ROOT); // GENERAL, DDAY, ROUTINE

                    ScheduleDialogManager.OnScheduleUpdatedListener refreshAndDismiss = newTodoId -> {
                    ...
                    try {
                        ScheduleDialogManager.ScheduleType scheduleType = ScheduleDialogManager.ScheduleType.valueOf(type);
                        dialogManager.showScheduleDialog(todoToEdit, null, scheduleType, refreshAndDismiss);
